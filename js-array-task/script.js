...
console.log("Duplicates of number two is:", arrCountTwos(numbers));
...
function arrIndexOfFirst(numbers, value) {
  return numbers.indexOf(value);
}
console.log(arrIndexOfFirst(numbers, 20));
...
function arrIndexOfLast(numbers, value) {
...
let reverseNum = [3, 2, 2, 4, 3];
function reverseNumbers(reverseNum) {
	return reverseNum.reverse();
}
console.log(reverseNumbers(reverseNum));
